...
class OrgNews
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Attachment", mappedBy="orgNews", cascade={"persist"})
     */
     private $attachments;
    ...
    public function removeAttachment(Attachment $attachment): self
    {
        if ($this->attachments->contains($attachment)) {
            ...
            if ($attachment->getOrgNews() === $this) {
                $attachment->setOrgNews(null);
            }
        }
